;(function(exports) {
	...
	Router.prototype.addSubRouter = function addSubRouter(route, router) {
	...
	Router.prototype.dispatch = function dispatch(request, response) {
		...
		for (var route in this._subRouters) {
			if (route === requestUrl.pathname) { // XXX has to match a partial of the route, not the entire thing. substring for absolutes (and relatives)?, and impossible for regex.
				this._subRouters[route].dispatch(request, response);
...
})(typeof exports === "undefined" ? this["lion"] = {} : exports);
