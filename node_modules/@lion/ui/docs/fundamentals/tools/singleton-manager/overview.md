...
⚠️ You need to make SURE that only ONE version of `singleton-manager` is installed. For how see [Non Goals](https://github.com/ing-bank/lion/blob/e930b7b667ceaf66c2fab86a76044d0260b934fa/docs/fundamentals/tools/singleton-manager/#non-goals).
...
➡️ See [it on the example page](https://github.com/ing-bank/lion/blob/e930b7b667ceaf66c2fab86a76044d0260b934fa/docs/fundamentals/tools/singleton-manager/example-fail/index.md). <br>
...
➡️ See [it on the example page](https://github.com/ing-bank/lion/blob/e930b7b667ceaf66c2fab86a76044d0260b934fa/docs/fundamentals/tools/singleton-manager/example-success/index.md). <br>
...
➡️ See [it on the example page](https://github.com/ing-bank/lion/blob/e930b7b667ceaf66c2fab86a76044d0260b934fa/docs/fundamentals/tools/singleton-manager/example-complex/index.md). <br>
