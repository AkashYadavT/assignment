...
As specified in the [overlay rationale](https://github.com/ing-bank/lion/blob/e930b7b667ceaf66c2fab86a76044d0260b934fa/docs/fundamentals/systems/overlays/rationale.md) there are only two official types of overlays: dialogs and tooltips. And their main differences are:
...
> An example implementation can be found in [lion-tooltip](https://github.com/ing-bank/lion/blob/e930b7b667ceaf66c2fab86a76044d0260b934fa/docs/components/tooltip/overview.md), where an arrow is set by default.
