...
export class LocalizeManager {
    constructor({ autoLoadOnLocaleChange, fallbackLocale, showKeyAsFallback, allowOverridesForExistingNamespaces, }?: {
    ...
    /** @private */
    private __allowOverridesForExistingNamespaces;
    /**
...
export type DatePostProcessor = import('../types/LocalizeMixinTypes.js').DatePostProcessor;
export type NumberPostProcessor = import('../types/LocalizeMixinTypes.js').NumberPostProcessor;
//# sourceMappingURL=LocalizeManager.d.ts.map