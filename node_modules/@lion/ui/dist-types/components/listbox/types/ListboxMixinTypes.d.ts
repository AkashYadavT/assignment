...
export declare class ListboxHost {
    ...
    private __pendingTypeAheadTimeout;
}
export declare function ListboxImplementation<T extends Constructor<LitElement>>(superclass: T): T & Constructor<ListboxHost> & Pick<typeof ListboxHost, keyof typeof ListboxHost> & Constructor<ChoiceGroupHost> & Pick<typeof ChoiceGroupHost, keyof typeof ChoiceGroupHost> & Constructor<SlotHost> & Pick<typeof SlotHost, keyof typeof SlotHost> & Constructor<FormRegistrarHost> & Pick<typeof FormRegistrarHost, keyof typeof FormRegistrarHost> & Constructor<FormControlHost> & Pick<typeof FormControlHost, keyof typeof FormControlHost> & Pick<typeof LitElement, keyof typeof LitElement>;
export declare type ListboxMixin = typeof ListboxImplementation;
//# sourceMappingURL=ListboxMixinTypes.d.ts.map