...
export declare class OverlayHost {
    ...
    private __setupSyncFromOverlayController;
    private __teardownSyncFromOverlayController;
    private __syncToOverlayController;
}
export declare function OverlayImplementation<T extends Constructor<LitElement>>(superclass: T): T & Constructor<OverlayHost> & Pick<typeof OverlayHost, keyof typeof OverlayHost> & Pick<typeof LitElement, keyof typeof LitElement>;
export declare type OverlayMixin = typeof OverlayImplementation;
//# sourceMappingURL=OverlayMixinTypes.d.ts.map