 ...
 */
export declare type SlotRerenderObject = {
...
export declare type SlotFunctionResult = TemplateResult | Element | SlotRerenderObject | undefined;
declare function slotFunction(): SlotFunctionResult;
export declare type SlotsMap = {
 ...
 * }
 */
declare function SlotMixinImplementation<T extends Constructor<LitElement>>(superclass: T): T & Constructor<SlotHost> & Pick<typeof SlotHost, keyof typeof SlotHost> & Pick<typeof LitElement, keyof typeof LitElement>;
export declare type SlotMixin = typeof SlotMixinImplementation;
export {};
//# sourceMappingURL=SlotMixinTypes.d.ts.map