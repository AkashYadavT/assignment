...
export declare type ValidationType = 'error' | 'warning' | 'info' | 'success' | string;
export declare class ValidateHost {
    ...
    private __syncValidationResult;
    private __asyncValidationResult;
    private __validationResult;
    private __prevValidationResult;
    private __prevShownValidationResult;
    private __childModelValueChanged;
    private __storePrevResult;
    private __executeValidators;
    private __validateCompleteResolve;
    private __executeSyncValidators;
    private __executeAsyncValidators;
    private __executeResultValidators;
    private __finishValidation;
    private __clearValidationResults;
    private __onValidatorUpdated;
    private __setupValidators;
    private __isEmpty;
    private __getFeedbackMessages;
}
export declare function ValidateImplementation<T extends Constructor<LitElement>>(superclass: T): T & Constructor<ValidateHost> & Pick<typeof ValidateHost, keyof typeof ValidateHost> & Constructor<FormControlHost> & Pick<typeof FormControlHost, keyof typeof FormControlHost> & Constructor<SyncUpdatableHost> & Pick<typeof SyncUpdatableHost, keyof typeof SyncUpdatableHost> & Constructor<DisabledHost> & Pick<typeof DisabledHost, keyof typeof DisabledHost> & Constructor<SlotHost> & Pick<typeof SlotHost, keyof typeof SlotHost> & Constructor<ScopedElementsHost> & Pick<typeof ScopedElementsHost, keyof typeof ScopedElementsHost> & Pick<typeof LitElement, keyof typeof LitElement>;
export declare type ValidateMixin = typeof ValidateImplementation;
//# sourceMappingURL=ValidateMixinTypes.d.ts.map