...
export declare type ModelValueEventDetails = {
    /**
...
export declare class FormControlHost {
    ...
    private __label;
    private __fieldName;
    private __reorderAriaLabelledNodes;
    private __reflectAriaAttr;
    private __reorderAriaDescribedNodes;
    private __getDirectSlotChild;
    private __repropagateChildrenInitialized;
    private __repropagateChildrenValues;
}
export declare function FormControlImplementation<T extends Constructor<LitElement>>(superclass: T): T & Constructor<FormControlHost> & Pick<typeof FormControlHost, keyof typeof FormControlHost> & Constructor<FormRegisteringHost> & Pick<typeof FormRegisteringHost, keyof typeof FormRegisteringHost> & Constructor<DisabledHost> & Pick<typeof DisabledHost, keyof typeof DisabledHost> & Constructor<SlotHost> & Pick<typeof SlotHost, keyof typeof SlotHost> & Pick<typeof LitElement, keyof typeof LitElement>;
export declare type FormControlMixin = typeof FormControlImplementation;
//# sourceMappingURL=FormControlMixinTypes.d.ts.map