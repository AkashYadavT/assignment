...
export declare type FormControl = FormControlHost & HTMLElement & {
...
export declare class FormGroupHost {
    ...
    private __descriptionElementsInParentChain;
    private __addedSubValidators;
    private __isInitialModelValue;
    private __isInitialSerializedValue;
    private __pendingValues;
    private __initInteractionStates;
    private __setupOutsideClickHandling;
    private __requestChildrenToBeDisabled;
    private __retractRequestChildrenToBeDisabled;
    private __linkParentMessages;
    private __unlinkParentMessages;
    private __storeAllDescriptionElementsInParentChain;
    private __onChildValidatePerformed;
}
export declare function FormGroupImplementation<T extends Constructor<LitElement>>(superclass: T): T & Constructor<FormGroupHost> & Pick<typeof FormGroupHost, keyof typeof FormGroupHost> & Constructor<FormRegistrarHost> & Pick<typeof FormRegistrarHost, keyof typeof FormRegistrarHost> & Constructor<FormControlHost> & Pick<typeof FormControlHost, keyof typeof FormControlHost> & Constructor<ValidateHost> & Pick<typeof ValidateHost, keyof typeof ValidateHost> & Constructor<DisabledHost> & Pick<typeof DisabledHost, keyof typeof DisabledHost> & Constructor<SlotHost> & Pick<typeof SlotHost, keyof typeof SlotHost> & Pick<typeof LitElement, keyof typeof LitElement>;
export declare type FormGroupMixin = typeof FormGroupImplementation;
//# sourceMappingURL=FormGroupMixinTypes.d.ts.map