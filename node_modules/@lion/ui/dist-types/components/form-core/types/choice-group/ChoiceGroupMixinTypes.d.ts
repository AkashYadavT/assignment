...
export declare class ChoiceGroupHost {
    ...
    private __setChoiceGroupTouched;
    private __delegateNameAttribute;
}
export declare function ChoiceGroupImplementation<T extends Constructor<LitElement>>(superclass: T): T & Constructor<ChoiceGroupHost> & Pick<typeof ChoiceGroupHost, keyof typeof ChoiceGroupHost> & Constructor<FormRegistrarHost> & Pick<typeof FormRegistrarHost, keyof typeof FormRegistrarHost> & Constructor<InteractionStateHost> & Pick<typeof InteractionStateHost, keyof typeof InteractionStateHost> & Pick<typeof LitElement, keyof typeof LitElement>;
export declare type ChoiceGroupMixin = typeof ChoiceGroupImplementation;
//# sourceMappingURL=ChoiceGroupMixinTypes.d.ts.map