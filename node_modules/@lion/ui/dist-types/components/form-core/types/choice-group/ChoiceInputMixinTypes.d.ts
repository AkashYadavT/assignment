...
export declare class ChoiceInputHost {
    ...
    private __syncModelCheckedToChecked;
    private __syncCheckedToModel;
    private __syncCheckedToInputElement;
}
export declare function ChoiceInputImplementation<T extends Constructor<LitElement>>(superclass: T): T & Constructor<ChoiceInputHost> & Pick<typeof ChoiceInputHost, keyof typeof ChoiceInputHost> & Constructor<FormatHost> & Pick<typeof FormatHost, keyof typeof FormatHost> & Pick<typeof LitElement, keyof typeof LitElement>;
export declare type ChoiceInputMixin = typeof ChoiceInputImplementation;
//# sourceMappingURL=ChoiceInputMixinTypes.d.ts.map