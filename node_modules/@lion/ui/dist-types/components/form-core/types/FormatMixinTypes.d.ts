...
export declare class FormatHost {
    ...
    private _reflectBackFormattedValueDebounced;
    /**
    ...
    private __preventRecursiveTrigger;
    private __prevViewValue;
}
export declare function FormatImplementation<T extends Constructor<LitElement>>(superclass: T): T & Constructor<FormatHost> & Pick<typeof FormatHost, keyof typeof FormatHost> & Constructor<ValidateHost> & Pick<typeof ValidateHost, keyof typeof ValidateHost> & Constructor<FormControlHost> & Pick<typeof FormControlHost, keyof typeof FormControlHost> & Pick<typeof LitElement, keyof typeof LitElement>;
export declare type FormatMixin = typeof FormatImplementation;
//# sourceMappingURL=FormatMixinTypes.d.ts.map