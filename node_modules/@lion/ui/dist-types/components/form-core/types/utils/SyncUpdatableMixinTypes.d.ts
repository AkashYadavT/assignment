...
export declare class SyncUpdatableHost {
    ...
    private __syncUpdatableInitialize;
    private __SyncUpdatableNamespace;
    private static __syncUpdatableHasChanged;
}
export declare type SyncUpdatableHostType = typeof SyncUpdatableHost;
export declare function SyncUpdatableImplementation<T extends Constructor<LitElement>>(superclass: T): T & Constructor<SyncUpdatableHost> & Pick<typeof SyncUpdatableHost, keyof typeof SyncUpdatableHost> & Pick<typeof LitElement, keyof typeof LitElement>;
export declare type SyncUpdatableMixin = typeof SyncUpdatableImplementation;
//# sourceMappingURL=SyncUpdatableMixinTypes.d.ts.map