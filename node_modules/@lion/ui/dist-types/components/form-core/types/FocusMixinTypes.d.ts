...
export declare class FocusHost {
    ...
    private __onFocus;
    private __onBlur;
    private __registerEventsForFocusMixin;
    private __teardownEventsForFocusMixin;
}
export declare function FocusImplementation<T extends Constructor<LitElement>>(superclass: T): T & Constructor<FocusHost> & Pick<typeof FocusHost, keyof typeof FocusHost> & Pick<typeof LitElement, keyof typeof LitElement>;
export declare type FocusMixin = typeof FocusImplementation;
//# sourceMappingURL=FocusMixinTypes.d.ts.map