 ...
 * feedback visibility
 */
export declare type InteractionStates = {
    submitted: boolean;
    touched: boolean;
    dirty: boolean;
    filled: boolean;
