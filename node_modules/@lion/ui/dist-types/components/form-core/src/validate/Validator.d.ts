...
export class Validator extends EventTarget {
     ...
     */
    static getMessage(data?: Partial<import("../../types/validate/validate.js").FeedbackMessageData> | undefined): Promise<string | Element>;
    /**
     * @param {ValidatorParam} [param]
     * @param {ValidatorConfig} [config]
     */
    constructor(param?: ValidatorParam, config?: import("../../types/validate/validate.js").ValidatorConfig | undefined);
    /** @type {ValidatorParam} */
     ...
     */
    execute(modelValue: any, param?: ValidatorParam, config?: import("../../types/validate/validate.js").ValidatorConfig | undefined): ValidatorOutcome | Promise<ValidatorOutcome>;
    /**
     ...
     */
    set config(arg: import("../../types/validate/validate.js").ValidatorConfig);
    get config(): import("../../types/validate/validate.js").ValidatorConfig;
    /**
     ...
     * @protected
     */
    protected _getMessage(data?: Partial<import("../../types/validate/validate.js").FeedbackMessageData> | undefined): Promise<string | Element>;
    /**
...
export type FeedbackMessageData = import('../../types/validate/index.js').FeedbackMessageData;
export type ValidatorParam = import('../../types/validate/index.js').ValidatorParam;
export type ValidatorConfig = import('../../types/validate/index.js').ValidatorConfig;
export type ValidatorOutcome = import('../../types/validate/index.js').ValidatorOutcome;
export type ValidatorName = import('../../types/validate/index.js').ValidatorName;
export type ValidationType = import('../../types/validate/index.js').ValidationType;
export type FormControlHost = import('../FormControlMixin.js').FormControlHost;
